...
const char olsr_node_movement_pr_cpp [] = "MIL_3_Tfile_Hdr_ 115A 30A op_runsim 7 4540BC95 4540BC95 1 apocalypse Jim@Hauser 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 d50 3                                                                                                                                                                                                                                                                                                                                                                                                   ";
#include <string.h>
...
#define pr_state_ptr            		((olsr_node_movement_state*) (OP_SIM_CONTEXT_PTR->_op_mod_state_ptr))
...
#  define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((olsr_node_movement_state *)(sim_context_ptr->_op_mod_state_ptr));
#else
	...
	
{
	...
	int line_nbr, node_id, i, j, list_size;
...
extern "C"
{
	...
	VosT_Address _op_olsr_node_movement_alloc (VOS_THREAD_INDEX_ARG_COMMA VosT_Obtype, int);
	void olsr_node_movement (OP_SIM_CONTEXT_ARG_OPT)
		{
...
olsr_node_movement_state::operator new (size_t)
	...
	new_ptr = Vos_Alloc_Object_MT (VOS_THREAD_INDEX_UNKNOWN_COMMA olsr_node_movement_state::obtype);
#if defined (VOSD_NEW_BAD_ALLOC)
...
VosT_Address
_op_olsr_node_movement_alloc (VOS_THREAD_INDEX_ARG_COMMA VosT_Obtype, int)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
