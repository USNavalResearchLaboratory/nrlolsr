/* Process model C form file: olsr_node_movement.pr.c */
/* Portions of this file copyright 1992-2006 by OPNET Technologies, Inc. */



/* This variable carries the header into the object file */
const char olsr_node_movement_pr_c [] = "MIL_3_Tfile_Hdr_ 120A 30A modeler 7 44FE30D9 44FE30D9 1 apocalypse Jim@Hauser 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 fec 0                                                                                                                                                                                                                                                                                                                                                                                                     ";
#include <string.h>
...
void
olsr_node_movement (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (olsr_node_movement ());
...
void
_op_olsr_node_movement_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	/* No Diagnostic Block */
	}
...
void
_op_olsr_node_movement_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{

	FIN_MT (_op_olsr_node_movement_terminate ())
...
/* local variable prs_ptr in _op_olsr_node_movement_svar function. */
#undef NODE_ID
...
_op_olsr_node_movement_init (int * init_block_ptr)
	...
	obtype = Vos_Define_Object_Prstate ("proc state vars (olsr_node_movement)",
...
VosT_Address
_op_olsr_node_movement_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	olsr_node_movement_state * ptr;
	FIN_MT (_op_olsr_node_movement_alloc (obtype))

	ptr = (olsr_node_movement_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "olsr_node_movement [init enter execs]";
#endif
		}
